...
namespace Avalonia
{
    ...
    public class AvaloniaObject : IAvaloniaObject, IAvaloniaObjectDebug, INotifyPropertyChanged
    {
        ...
        {
            _ = property ?? throw new ArgumentNullException(nameof(property));
            return _values.GetBaseValue(property, BindingPriority.Style, maxPriority);
        }
        ...
        internal void InheritanceParentChanged()
        {
            _values.InheritanceParentChanged(InheritanceParent?._values);
        }
            ...
            bool isEffectiveValue)
        {
            ...
            try
            {
                ...
                if (property.Inherits && _inheritanceChildren?.Count > 0)
                {
